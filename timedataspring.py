...
data = pd.read_excel('soc4252.xls.xlsx')
data = data.drop(data.columns[0], axis=1)
#9-11
data = data.drop(data.columns[8:11], axis=1)
data = data.iloc[8:]
...
final_data = pd.DataFrame([
    {
        ...
        "Semester": 0 #1 for Fall, 0 for Spring
    }
...
final_data.to_excel("spring_times.xlsx", index=False)
